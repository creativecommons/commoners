...
function commoners_registration_individual_post_last_form () {
...
function commoners_registration_individual_shortcode_render ( $atts ) {
    ...
    case COMMONERS_APPLICATION_STATE_DETAILS:
        gravity_form( COMMONERS_GF_INDIVIDUAL_DETAILS, false, false );
        break;
