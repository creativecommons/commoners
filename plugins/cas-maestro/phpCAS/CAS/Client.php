...
class CAS_Client
{
    ...
    */
	...
	// If Apache is serving on one port to a cache and the cache is on another
	// or if there's any problem with the canonical host name and specified port differing
	// then this will give https://hostname:80/, which breaks.
	// So comment it our as we don't want this behaviour.
